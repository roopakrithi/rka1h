...
- creating the package using "create" seems to messthings up if I want to create a git Repo.I still haven't figured out why but in the meantime I'll be creating packages in the way outmined above
- 
